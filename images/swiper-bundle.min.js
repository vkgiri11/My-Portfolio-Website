        ...
        const d = t > i ? "next" : "prev",
            ...
            p = () => {
                ...
                if ((c(u, t) && (u = t), e.wrapperEl.scrollTo({ [s]: u }), c(u, t)))
                    return (e.wrapperEl.style.scrollSnapType = ""), void a.cancelAnimationFrame(e.cssModeFrameID);
                    ...
                    for (let i = 0; i < p; i += 1) {
                        ...
                        if ((C && e.grid.updateSlide(i, n, p, t), "none" !== n.css("display"))) {
                            if ("auto" === a.slidesPerView) {
                                ...
                                if ((i && (n[0].style.transform = "none"), r && (n[0].style.webkitTransform = "none"), a.roundLengths))
        ...
        function ({ swiper: e, extendParams: t, on: s }) {
            ...
            function i(t) {
                ...
                (m = e.rtlTranslate ? "right" : e.isHorizontal() ? "left" : "top"),
                    r ? ((f = Math.floor(s / 2) + i + l), (g = Math.floor(s / 2) + i + n)) : ((f = s + (i - 1) + l), (g = i + n));
                            ...
                            if (t < -e.minTranslate()) e.slideTo(e.activeIndex);
                                ...
                                if (i.freeMode.momentum) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ((t = n ? Math.abs((-c - e.translate) / e.velocity) : Math.abs((c - e.translate) / e.velocity)),
                                            i.freeMode.sticky)
                                        ) {
